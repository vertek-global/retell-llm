...
export declare class Call extends APIResource {
     ...
     * ```
     */
    update(callId: string, body: CallUpdateParams, options?: Core.RequestOptions): Core.APIPromise<CallResponse>;
    /**
     ...
     * ```
     */
    createPhoneCall(body: CallCreatePhoneCallParams, options?: Core.RequestOptions): Core.APIPromise<PhoneCallResponse>;
    /**
     ...
     * ```
     */
    registerPhoneCall(body: CallRegisterPhoneCallParams, options?: Core.RequestOptions): Core.APIPromise<PhoneCallResponse>;
}
...
export interface PhoneCallResponse {
     ...
     */
    disconnection_reason?: 'user_hangup' | 'agent_hangup' | 'call_transfer' | 'voicemail_reached' | 'inactivity' | 'max_duration_reached' | 'concurrency_limit_reached' | 'no_valid_payment' | 'scam_detected' | 'error_inbound_webhook' | 'dial_busy' | 'dial_failed' | 'dial_no_answer' | 'error_llm_websocket_open' | 'error_llm_websocket_lost_connection' | 'error_llm_websocket_runtime' | 'error_llm_websocket_corrupt_payload' | 'error_no_audio_received' | 'error_asr' | 'error_retell' | 'error_unknown' | 'error_user_not_joined' | 'registered_call_timeout';
    /**
